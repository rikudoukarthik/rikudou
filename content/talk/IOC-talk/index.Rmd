...
![:scale 81%](pics/soib-example.png)
...
[`r icons::fontawesome("twitter")` @TrickDEerie](https://twitter.com/TrickDEerie)  
[`r icons::fontawesome("link")` kartrick.rbind.io](https://kartrick.rbind.io)  
[`r icons::fontawesome("paper-plane")` karthik.t@ncf-india.org](mailto:karthik.t@ncf-india.org)
]

#### Slide deck: 
[]()

.footnote[Made with &#10084; and [![:scale 2%](pics/xaringan.png)](https://github.com/yihui/xaringan)]
